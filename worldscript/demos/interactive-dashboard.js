    ...
    children: [
        ...
        group("animationDisplay", {
            ...
            children: [
                ...
                // Orbiting elements
                ...Array.from({ length: 6 }, (_, i) => shape("ellipse", {
                    id: `orbitElement${i}`,
                    ...
                    style: {
                        fill: {
                            type: "solid",
                            color: `hsl(${i * 60 + colorDriver * 360}, 70%, 60%)`
                        },
                ...
                // Connection lines
                ...Array.from({ length: 6 }, (_, i) => shape("polyline", {
                    id: `connection${i}`,
                    points: [
                        [325, 225], // Center
                        [
                    ...
                    style: {
                        stroke: {
                            color: `hsla(${i * 60 + colorDriver * 360}, 70%, 60%, 0.3)`,
                            width: 2,
                            dasharray: "3 3"
                        }
                    }
...
//# sourceMappingURL=interactive-dashboard.js.map