...
import { scene, shape, textNode, poses, reactive } from "../src/dsl/api.js";

// Poses for interactive elements
const sliderPoses = poses({
    idle: {
...
export const interactiveDemo = scene({
    render: {
        width: 1280,
        height: 720,
        fps: 60,
...
console.log(JSON.stringify(interactiveDemo, null, 2));